...
| 14  | [Advanced Processors](advanced-processors.md) | Deep dive into all extraction strategies       |
...
| Page                                          | Description                                     |
| --------------------------------------------- | ----------------------------------------------- |
| [Advanced Processors](advanced-processors.md) | All extraction strategies (standard & advanced) |
